    ...
    <div className='  h-[105vh]'>
      ...
      <div className='flex  justify-center items-center mt-28 text-center'>
        ...
        <div className='flex flex-col gap-5 justify-center items-center'>
          <h2 className='text-6xl font-bold  text-[#0dc167]'>The Ultimate Shop</h2>
          <h2 className='text-5xl text-white  font-semibold'>for Second Hand Market</h2>
          <p className='text-2xl text-slate-400'>Fully Trustable .</p>
