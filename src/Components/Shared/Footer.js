...
const Footer = () => {
  return (
    <div>
      ...
      <footer aria-label="Site Footer" className="footer-bg">
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md">
            <strong
              className="block text-center text-xl font-medium text-slate-500 sm:text-3xl"
            >
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div className="mx-auto max-w-sm lg:max-w-none">
              <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                one of the best online shop in bangladesh. feel free to purchase any products with our trustable Sellers
              </p>
          ...
          <div className="mt-16 border-t border-gray-100 pt-8">
            <div className="text-center text-xs leading-relaxed text-gray-500">
              ...
              >REACT JS</p>
              by
              <a className='text-gray-700 underline transition hover:text-gray-700/75' href="https://github.com/shourovr82">Shourovr82</a>
